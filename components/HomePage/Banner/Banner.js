...
export default function Banner() {
  ...
  return (
    <div className="">
      <div className="">
        <div className="flex h-[70vh] w-screen bg-[url('https://ivista-digital-bucket.blr1.cdn.digitaloceanspaces.com/Seslong/home-page-banner-mobile.png')] bg-cover bg-center bg-no-repeat lg:bg-[url('/banner.jpeg')]">
          <div className="container mx-auto flex items-center justify-center p-5 text-center text-2xl text-white lg:text-5xl">
            <div className="inline-block bg-black bg-opacity-65 px-6 py-4 mt-56">
              <p>
