...
export default function OurPresence() {
  return (
    <div className="grid-row bg-[#E5E5E4] py-10 md:grid md:grid-cols-2">
      {/* paragraph field */}
      <div className="order-1 mx-auto flex flex-col items-center justify-center  md:order-2  lg:h-[50vh]  lg:w-9/12 l lg:pr-40">
        <h2 className="text-3xl font-medium lg:text-4xl">Our Customers</h2>
        <p className="text-center text-[20px] font-normal p-5">
