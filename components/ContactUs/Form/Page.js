    ...
    >
      ...
      <form className="mx-auto py-8" onSubmit={onSubmit}>
        ...
        <div className="py-4">
          <button
            type="submit"
            className="font-regular flex w-full items-center justify-center gap-2 border-2 border-gray-300 px-5 py-2.5 text-center text-xl text-gray-600 hover:bg-gray-800 hover:text-white lg:w-6/12"
          >
