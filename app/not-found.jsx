...
export default function Custom404() {
  return (
    <div className=" -mt-10 flex h-[90vh] items-center justify-center bg-black">
      <div className="relative w-52 lg:w-[600px]">
        <svg
          version="1.1"
        ...
        l-66.01,77.67H669.99z"
          />
          <path
            className="fill-none stroke-[#F5841F] stroke-[12]"
            strokeDasharray="200 100"
        ...
        <h1 className="absolute inset-x-0 mt-10 flex flex-col justify-center gap-3 text-center text-center text-4xl font-bold text-white lg:flex-row">
          Go Back to{" "}
          <Link href="/" className="text-[#F5841F]">
